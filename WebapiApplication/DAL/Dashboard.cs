...
namespace WebapiApplication.DAL
{
    public class Dashboard
    {
        ...
        public DashboardClass GetPartnerProfilesDal(int? CustID, string TypeOfReport, int pagefrom, int pageto, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(ex.Message), CustID, "GetPartnerProfilesDal", null);
            }
            finally
            {
                con.Close();
        ...
        public List<PartnerProfilesLatest> ExpressInterestSelectDal(DashboardRequest Dreq)
        {
            ...
            {
                Commonclass.ApplicationErrorLog("[dbo].[usp_select_customerDashboard_ExpressInterest]", Convert.ToString(ex.Message), Dreq.IntCustID, "ExpressInterestSelectDal", null);
            }
            finally
            {
                connection.Close();
        ...
        public List<DashboardRequestChats> DgetCustometExpressIntrestDashBoardchats(long? CustID, int? Status, int iStartIndex, int iEndIndex, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), CustID, "DgetCustometExpressIntrestDashBoardchats", null);
            }
            finally
            {
                connection.Close();
        ...
        public List<TicketHistoryinfoResponse> GetTicketinformationDal(long? Ticketid, char Type, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(ex.Message), Ticketid, "GetTicketinformationDal", null);
            }
            finally
            {
                connection.Close();
        ...
        public List<CommunicationHistry> GetCustometMessagesCount(CommunicationHistoryReq Mobj, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), Mobj.CustID, "GetCustometMessagesCount", null);
            }
            finally
            {
        ...
        public int InsertExpressViewTicket(long? FromCustID, long? ToCustID, string EncriptedText, string strtypeOfReport, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), FromCustID, "InsertExpressViewTicket", null);
            }
            finally
            {
                connection.Close();
        ...
        public int InsertCustomerExpressinterest(int? fromcustid, int? tocustid, long? logID, string interstTYpe, int? empid, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), fromcustid, "InsertCustomerExpressinterest", null);
            }
            finally
            {
