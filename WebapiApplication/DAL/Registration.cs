...
namespace WebapiApplication.DAL
{
    public class RegistrationDAL
    {
        public int? DRegisterCustomerHomepages(PrimaryInformationMl Mobj, string spName)
        {
            ...
            try
            {
                ...
                if (intStatus.Equals(1))
                {
                    ...
                    {
                        Commonclass.ApplicationErrorLog(spName, (Convert.ToString(EX.Message) + "send Sms Error"), Mobj.intCusID, "DRegisterCustomerHomepages", null);
                    }
                }
            }
            catch (Exception EX)
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), Mobj.intCusID, "DRegisterCustomerHomepages", null);
            }
            finally
            {
                connection.Close();
        ...
        public int DgetCustomerRegProfileDetails_Myprofile(UpdatePersonaldetails Mobj, string spName)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(spName, Convert.ToString(EX.Message), Mobj.intCusID, "DgetCustomerRegProfileDetails_Myprofile", null);
            }
            finally
            {
        ...
        public ArrayList CustomermissindDatagetting(long? CustomerCustID, string strSpname)
        {
            ...
            {
                Commonclass.ApplicationErrorLog(strSpname, Convert.ToString(Ex.Message), @CustomerCustID, "CustomermissindDatagetting", null);
            }
            finally
            {
        ...
        public string BgetPassword(string Username)
        {
            ...
            {
                Commonclass.ApplicationErrorLog("Usp_GetPasswordforlogged", Convert.ToString(Ex.Message), null, "BgetPassword", null);
            }
            finally
            {
        ...
        public int CheckUserPwd(string Username, string Password)
        {
            ...
            {
                Commonclass.ApplicationErrorLog("[dbo].[usp_checkuserpwd]", Convert.ToString(EX.Message), null, "CheckUserPwd", null);
            }
            finally
            {
                connection.Close();
